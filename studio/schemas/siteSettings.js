  ...
  fields: [
      ...
      of: [
        {
          ...
          fields: [
            { name: 'label', type: 'string' },
            {
              ...
              title: 'Link',
              type: 'link',
              description: 'Link out (e.g. LinkedIn) OR upload a file directly (e.g. your resume PDF).',
            },
          ],
        },
      ],
    },
    {
      ...
      fields: [
        ...
        { name: 'skills', title: 'Show Skills', type: 'boolean', initialValue: true },
        ...
        { name: 'talks', title: 'Show Talks', type: 'boolean', initialValue: true },
        { name: 'patents', title: 'Show Patents', type: 'boolean', initialValue: true },
