// Copy this file to config.js and fill in your own Sanity project details
// (sanity.io/manage). config.js is gitignored so your project ID never
// gets committed or pushed to a public repo.
